...
subtitle: "Part 1. Population structure inference using discriminant analysis"
...
cattle_klfda=klfda_1(as.matrix(cattle_geno[,-1]),as.factor(cattle_pop$x),r=3,tol=1E-10,prior = NULL)
